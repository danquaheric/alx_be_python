...
def remove_item(shopping_list):
    ...
    # Try to remove by exact match (case-sensitive)
    if item in shopping_list:
        shopping_list.remove(item)
        print(f"'{item}' has been removed from your shopping list.")
        return

    # If exact match not found, try a case-insensitive match
    ...
    # Offer to show current list and remove by index if user prefers
